                ...
                <div class="hidden lg:flex lg:items-center lg:gap-2 flex-wrap">
                    ...
                    <div class="relative" x-data="{ show: false }" @click.away="show = false">
                        <button @mouseenter="show=true" @click="show = !show" class="inline-flex items-center gap-1.5 px-3.5 py-2 text-sm font-semibold text-gray-600 hover:text-indigo-600 rounded-xl hover:bg-gray-50 transition-all duration-200">
                            <span>Products</span>
                            <svg class="w-4 h-4 transition-transform duration-200" :class="{ 'rotate-180 text-indigo-600': show }" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        </button>
                        <div x-show="show" 
                    ...
                    <div class="relative" x-data="{ show: false }" @click.away="show = false">
                        <button @mouseenter="show=true" @click="show = !show" class="inline-flex items-center gap-1.5 px-3.5 py-2 text-sm font-semibold text-gray-600 hover:text-green-600 rounded-xl hover:bg-green-50 transition-all duration-200">
                            ...
                            <svg class="w-4 h-4 transition-transform duration-200" :class="{ 'rotate-180 text-green-600': show }" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        </button>
                        <div x-show="show" 
                             x-transition:enter="transition ease-out duration-150"
                             x-transition:enter-start="opacity-0 scale-95 transform"
